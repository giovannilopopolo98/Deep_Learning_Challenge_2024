...
# from swin_transf_model import DepthEstimationModel
# from DenseNet121_model import DepthEstimationModel
import numpy as np
...
class Solver():
    ...
    def __init__(self, args):
        ...
        train_transforms = transforms.Compose([
            transforms.Resize((224, 224)),                       # Ridimensiona le immagini alla risoluzione desiderata
            transforms.CenterCrop((224, 224)),                   # Esegue il centro ritaglio delle immagini    
        ])

        # Trasformazioni per il dataset di validazione (senza augmentation)
        ...
        if self.args.is_train:
            ...
            self.test_set = DepthDataset(train=DepthDataset.VAL,        # Cambiato da DepthDataset.TEST a DepthDataset.VAL
