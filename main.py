...
def main():
    ...
    parser.add_argument("--ckpt_file", type=str, default="D:/UNIVERSITA/MAGISTRALE/SECONDO_ANNO/PRIMO_SEMESTRE/Deep_Learning/Script/CHALLENGE/CHALLENGE/checkpoint/depth_v_0.4_83.pth")
